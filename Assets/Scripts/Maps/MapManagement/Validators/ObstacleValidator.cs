...
namespace Maps.MapManagement.Validators
{
    ...
    {
        private readonly MapObstacleData _obstacleData;
        public ObstacleValidator(MapObstacleData obstacleData)
        {
        ...
        public bool IsValid(int x, int y)
        {
            ...
            return _obstacleData.regions.Any(region => region.IsBlocked(new Vector2Int(x,y)));
        }
    }
}